    ...
    return (
        ...
        <ScrollView contentContainerStyle={stylesContainers.scrollContainer}>
            ...
            <View style={stylesAccountCreated.textContainer}>
                ...
                <Text style={stylesAccountCreated.text}>Pour que nous puissions trouver la solution la plus adaptée, nous avons besoin que vous complétiez le profil de votre proche </Text>
            </View>
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    ...
                    style={styles.button}
                    >
                    <Text style={styles.textButton}>Compléter le profil de mon proche</Text>
                </TouchableOpacity>
            </View>
